# Observações Editoriais para Agentes de IA — OpenSciMD / LeiaME
...
- **Separação de Namespaces (Autor vs. Tradutor vs. Editor)**: Para evitar colisão com a numeração do autor original, adote prefixos semânticos dedicados:
  ...
  - Para documentação detalhada, consulte [`docs/padrao-de-notas-e-aparato-critico.md`](docs/padrao-de-notas-e-aparato-critico.md).
